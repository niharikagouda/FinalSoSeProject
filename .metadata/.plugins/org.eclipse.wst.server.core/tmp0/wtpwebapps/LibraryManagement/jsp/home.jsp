...
<title>Library Management Student page</title>
<h2 style = "padding=left: 37%" align="center">Library Management Student Page</h2>
...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
	...
	<script>
		...
		function issueBook(index){
			...
			var url = "http://localhost:8082/LibraryManagement/issueBook?userId="+user+"&bookId="+isbn;
			...
			$.ajax({
				...
				success : function(data, textStatus, jqXHR) {
					if(data)
						...
						alert('Book already assigned to another user')
